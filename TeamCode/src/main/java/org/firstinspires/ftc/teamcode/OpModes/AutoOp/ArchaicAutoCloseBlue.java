...
//@Disabled
@Autonomous(name="ArchaicAutoCloseBlue", group="Autonomous", preselectTeleOp = "MainTeleOp")
public class ArchaicAutoCloseBlue extends RobotConfiguration implements TeamConstants {
