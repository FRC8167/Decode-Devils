...
//@Disabled
@Autonomous(name="OldArchaicAutoCloseRed", group="Autonomous", preselectTeleOp = "MainTeleOp")
public class OldArchaicAutoCloseRed extends RobotConfiguration implements TeamConstants {
