package org.firstinspires.ftc.teamcode.Cogintilities.Other.controller;
...
public class PIDFController extends Controller {
    ...
    protected double calculateOutput(double pv) {
        ...
        // returns u(t)
        return kP * errorVal_p + kI * totalError + kD * errorVal_v + kF * (atSetPoint() ? 0:Math.signum(errorVal_p)); //* setPoint;
    }
